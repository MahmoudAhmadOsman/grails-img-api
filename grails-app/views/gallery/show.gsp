...
<html>
    ...
    <body>
        ...
        <div id="show-gallery" class="content scaffold-show" role="main">
            ...
            <f:display bean="gallery" />
            <g:form resource="${this.gallery}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gallery}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
