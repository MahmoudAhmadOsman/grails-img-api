...
<html>
    ...
    <body>
        ...
        <div id="edit-gallery" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.gallery}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.gallery}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.gallery}" method="PUT">
                <g:hiddenField name="version" value="${this.gallery?.version}" />
                <fieldset class="form">
                    <f:all bean="gallery"/>
                </fieldset>
